...
public abstract class JwtUtils {
    ...
    public static String signedJWTTokenRSA256(String userId, String name, String email, String username)
            throws Exception {
    ...
    public static String signedJWTTokenRSA256(String userId, String name, String email, String username,
        ...
        RSAKey rsaJWK = RSAKey.parse(IOUtils.toString(
                new ClassPathResource("jwk.json").getInputStream(), StandardCharsets.UTF_8));
        JWSSigner signer = new RSASSASigner(rsaJWK);
        SignedJWT signedJWT = new SignedJWT(
                new JWSHeader.Builder(JWSAlgorithm.RS256)
                        .keyID(rsaJWK.getKeyID()).type(JOSEObjectType.JWT).build(),
                claims(userId, name, email, username, roles));
        signedJWT.sign(signer);
        return signedJWT.serialize();
    }

    public static String signedJWTTokenHS256(String userId, String name, String email, String username)
            throws Exception {
    ...
    protected static JWTClaimsSet claims(String userId, String name, String email, String username,
            List<String> roles) {
